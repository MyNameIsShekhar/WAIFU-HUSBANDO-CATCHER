...
async def message_counter(update: Update, context: CallbackContext) -> None:
    ...
    async with lock:
        ...
        if chat_frequency:
            message_frequency = chat_frequency.get('message_frequency', 3)
        else:
            message_frequency = 3
